...
async def style_buttons(c, m, cb=False):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton("𝑆𝑒𝓇𝒾𝒻", callback_data="style+cool"),
...
async def style(c, m):
    ...
    try:
        original = m.message.reply_to_message.text.split(" ", 1)[1]
        new_text = font_map[style](original)
...
__help__ = """
❍ /fonts <text> *:* ᴄᴏɴᴠᴇʀᴛs sɪᴍᴘʟᴇ ᴛᴇxᴛ ɪɴᴛᴏ ʙᴇᴀᴜᴛɪғᴜʟ ғᴏɴᴛ sᴛʏʟᴇs.
"""
